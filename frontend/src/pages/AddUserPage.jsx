      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-xl border border-gray-50 dark:border-slate-800 p-10 md:p-14">
          <div className="mb-10 flex flex-col items-center">
            ...
            <h1 className="text-3xl font-bold text-text-main text-center">Add New User</h1>
            <p className="text-text-muted mt-2 font-medium">Create a new user account and assign a role.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div>
                <label className="text-[10px] font-bold text-text-muted uppercase tracking-[0.2em] mb-2 block px-2">Password</label>
                <div className="relative">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-4 bg-brand text-white font-bold rounded-2xl shadow-xl shadow-brand/20 hover:opacity-90 transition-all active:scale-[0.98] mt-4 flex items-center justify-center gap-2"
            >
